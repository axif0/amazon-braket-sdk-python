...
FreeParameterExpression for mathematical expressions, OpenQASM 3 math-function
helpers (``sin``, ``cos``, ``arcsin``, ``mod``, and others), and the
Parameterizable interface for parameter binding.
"""
